...
class Settings:
    ...
    approval_ttl_minutes: int = int(os.getenv("APPROVAL_TTL_MINUTES", "30"))
    ...
    oidc_claim_namespace: str = os.getenv(
        "OIDC_CLAIM_NAMESPACE", "https://github.com/samgulati/cirt-lens"
    )
    ...
    privileged_action_after_auth_window_minutes: int = int(
        os.getenv("PRIVILEGED_ACTION_AFTER_AUTH_WINDOW_MINUTES", "60")
    )
