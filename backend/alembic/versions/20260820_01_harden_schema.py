...
def upgrade():
    ...
    if "incidents" not in tables:
        op.create_table(
            ...
            sa.Column("primary_user", sa.String()),
            sa.Column("primary_host", sa.String()),
            sa.Column("source_ips", sa.Text(), nullable=False, server_default="[]"),
            ...
            sa.Column(
                "incident_type", sa.String(), nullable=False, server_default="Security Incident"
            ),
            sa.Column("residual_risk_score", sa.Integer(), nullable=False, server_default="0"),
            sa.Column("triaged_at", sa.DateTime()),
            sa.Column("incident_fingerprint", sa.String()),
            sa.Column("confidence_breakdown", sa.Text(), nullable=False, server_default="{}"),
            sa.Column("disposition", sa.String(), nullable=False, server_default="UNSET"),
        )
        op.create_index(
            "ix_incidents_incident_fingerprint", "incidents", ["incident_fingerprint"], unique=True
        )
    definitions = {
        "activity": [
        ...
        "detection_findings": [
            ...
            sa.Column("created_at", sa.DateTime(), nullable=False),
            sa.UniqueConstraint("event_id", "rule_id", "flag", name="uq_finding_event_rule_flag"),
        ],
        "analyst_notes": [
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("incident_id", sa.String(), nullable=False),
        ...
        "evidence_bookmarks": [
            ...
            sa.Column("timestamp", sa.DateTime(), nullable=False),
            sa.UniqueConstraint("incident_id", "event_id", name="uq_bookmark_incident_event"),
        ],
        "incident_risk_history": [
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("incident_id", sa.String(), nullable=False),
            sa.Column("timestamp", sa.DateTime(), nullable=False),
            sa.Column("original_risk", sa.Integer(), nullable=False),
    ...
    if "incidents" in inspector.get_table_names():
        ...
        additions = [
            ("incident_type", sa.String(), "Security Incident"),
            ("residual_risk_score", sa.Integer(), "0"),
            ("triaged_at", sa.DateTime(), None),
            ("incident_fingerprint", sa.String(), None),
            ("confidence_breakdown", sa.Text(), "{}"),
            ("disposition", sa.String(), "UNSET"),
        ]
        ...
        if "ix_incidents_incident_fingerprint" not in indexes:
            op.create_index(
                "ix_incidents_incident_fingerprint",
                "incidents",
