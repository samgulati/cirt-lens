...
function AuthUser() {
  ...
  const roles =
    (user?.[`${claimNamespace}/roles`] as string[] | undefined) || [];
  return (
    <div className="flex items-center gap-3 border-l border-[#294254] pl-4">
      <div className="text-right leading-tight">
        <div className="text-xs font-semibold max-w-40 truncate">
...
export default function Shell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex">
      <aside className="w-56 fixed inset-y-0 border-r border-[#1c3445] bg-[#09151f] flex flex-col z-20">
        <div className="h-16 flex items-center px-5 gap-3 border-b border-[#1c3445]">
          ...
          <div>
            ...
            <div className="text-[9px] tracking-[.18em] text-slate-500">
              SECURITY OPERATIONS
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black/70 z-50 grid place-items-center">
          <div className="panel w-[480px] p-6 shadow-2xl">
            ...
            <p className="text-sm muted mt-2">
              Generate raw telemetry, validate it, run detections, correlate
              evidence, score risk, and derive the investigation.
            </p>
            <div className="space-y-2 mt-5">
              {[
                [
                  ...
                  "MFA fatigue and impossible travel",
                ],
                [
                  "endpoint",
                  "Endpoint Compromise",
                  "PowerShell, credential access, and C2",
                ],
                [
                  "exfiltration",
                  "Data Exfiltration",
                  "Sensitive access and unusual egress",
                ],
