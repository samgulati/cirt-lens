...
export default function AuthGate(){
  const {isLoading,isAuthenticated,error,loginWithRedirect,getAccessTokenSilently,user}=useAuth0();
  ...
  return <AuthorizationProvider roles={roles}><App/></AuthorizationProvider>;
}
